...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private ArrayList id, name, type , location, date;

    public MyAdapter(Context context, ArrayList id, ArrayList name, ArrayList type, ArrayList location, ArrayList date) {
